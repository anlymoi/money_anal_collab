...
5. Реализовать миграции для БД

6. Проработать таблицы и витрины в БД, наполнить данными:
